...
### 'спецификация ссылок'
git push -u origin featureB:featureBee - отправить изменения из локальной ветки featureB в удаленную ветку featureBee на сервере.
...
### git log --no-merges issue54..origin/master issue54..origin/master — это синтаксис фильтра, который указывает Git отображать только список коммитов, которые существуют в последней ветке (в данном случае origin/master), но отсутствуют в первой (в данном случае issue54).
